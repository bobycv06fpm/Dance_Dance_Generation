...
NUM_CLASSES = 7
DATA_LIST = '/aibridge/DDG4_ALp/WSHP-master/parsing_network/datalist'
SAVE_DIR = './output/'

DATA_DIRECTORY ='/aibridge/DDG4_ALp/WSHP-master/parsing_network/image/'

RESTORE_FROM = '/aibridge/DDG4_ALp/WSHP-master/parsing_network/models/final_model/model.ckpt-19315'
