...
def c7s1_k(input, k, reuse=False, norm='instance', activation='relu', is_training=True, name='c7s1_k'):
  """ A 7x7 Convolution-BatchNorm/InstanceNorm-ReLU layer with k filters and stride 1
  Args:
    input: 4D tensor
...
def Ck(input, k, slope=0.2, stride=2, reuse=False, norm='instance', is_training=True, name=None, no_norm=False):
