...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 16:22:49 2019
...
##
##tf.flags.DEFINE_string('X_input_dir', '/home/user/Downloads/facades/train',
##                       'X input directory, /home/user/Downloads/facades/train')
##tf.flags.DEFINE_string('Y_input_dir', 'data/apple2orange/trainB',
##                       'Y input directory, default: data/apple2orange/trainB')
#tf.flags.DEFINE_string('X_output_file', '/home/user/Downloads/facades/data.tfrecords',
#                       'X output tfrecords file, default: /home/user/Downloads/facades/data.tfrecords')
...
def main(unused_argv):
  ...
  input_dir = '/home/user/Downloads/facades/train'
  output_dir = '/home/user/Downloads/facades/data.tfrecords'
  data_writer(input_dir, output_dir)
